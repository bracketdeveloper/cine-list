    ...
    <div class="max-w-screen-xl mx-auto">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div class="lg:flex lg:items-center">
          <router-link to="/">
            <a>
              <img src="../assets/logo-no-bg.png" alt="logo" class=" logo-image w-48"/>
            </a>
          </router-link>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-4">
            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'>
              <router-link to="/"><a class='text-slate-400 hover:text-white text-sm'>Home</a>
              </router-link>
            </li>
            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'>
              <router-link to="/movies"><a class='text-slate-400 hover:text-white text-sm'>Movies</a>
              </router-link>
            </li>

            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'>
              <router-link to="/tv-shows"><a class='text-slate-400 hover:text-white text-sm'>TV Shows</a>
              </router-link>
            </li>
            <li class='max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3'>
              <router-link to="/watchlist"><a class='text-slate-400 hover:text-white text-sm'>Watch
                List</a></router-link>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-4">
            <li>
              <router-link to="/about"><a class="text-slate-400 hover:text-white text-sm">About Us</a></router-link>
            </li>
            <li>
              <router-link to="/contact"><a class="text-slate-400 hover:text-white text-sm">Contact Us</a></router-link>
            </li>
            <li>
              <router-link to="/terms-and-conditions"><a class="text-slate-400 hover:text-white text-sm">Terms &amp;
                Conditions</a></router-link>
            </li>
            <li>
              <router-link to="/privacy-policy"><a class="text-slate-400 hover:text-white text-sm">Privacy Policy</a>
              </router-link>
            </li>
          </ul>
        </div>
      ...
      <p class="text-slate-400 text-sm mt-10">© MAS. All rights reserved.
      </p>
    </div>
  </footer>
</template>
